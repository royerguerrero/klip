...
export function DashboardNav() {
  ...
  return (
    <nav className="flex gap-2 border-b w-full px-2">
      {items.map((item) => {
        ...
        return (
          <Button
            key={item.label}
            variant="ghost"
            className={`border-b-2 rounded-none text-neutral-400 hover:border-primary/80 hover:text-primary hover:bg-inherit mt-2 ${
